...
Ein älterer Erwachsener, typischerweise ab 65 Jahren, obwohl die Framework-Prinzipien Nutzern aller Altersgruppen zugutekommen. Der Begriff betont Respekt und Würde statt Einschränkungen.

### Altersinklusives Design / Age-Inclusive Design
Design, das die Bedürfnisse von Nutzern aller Altersgruppen berücksichtigt, mit besonderer Aufmerksamkeit für die Bedürfnisse von Seniorennutzern.
...
### Rückgängig machbare Aktionen / Reversible Actions
Operationen, die rückgängig gemacht werden können, sodass Nutzer ohne Angst vor dauerhaften Fehlern erkunden können.

### Vertraute Muster / Familiar Patterns
Schnittstellenelemente und Verhaltensweisen, die den bestehenden mentalen Modellen und vergangenen Erfahrungen der Nutzer entsprechen.
...
Eine definierte Methode zur Überprüfung, ob eine Anforderung ordnungsgemäß implementiert wurde.
...
Eine Anforderung oder Spezifikation, die objektiv durch definierte Testverfahren verifiziert werden kann.
...
Systemantwort, die Nutzer über das Ergebnis ihrer Aktionen informiert.
...
### Digitale Inklusion / Digital Inclusion
Das Ziel sicherzustellen, dass alle Menschen Zugang zu digitalen Technologien haben und davon profitieren können.

### Universelles Design / Universal Design
Designansatz, der darauf abzielt, Produkte für alle Menschen im größtmöglichen Umfang nutzbar zu machen.

### Assistive Technologie / Assistive Technology
Hard- oder Software, die Menschen mit Behinderungen oder altersbedingten Einschränkungen bei der Nutzung digitaler Produkte hilft. Beispiele: Screenreader, Bildschirmlupen, Sprachsteuerung.

### Mentales Modell / Mental Model
Das interne Verständnis eines Nutzers darüber, wie etwas funktioniert, basierend auf Erfahrungen und Erwartungen.

### Barrierefreiheit / Accessibility
Die Praxis, digitale Produkte für Menschen mit Behinderungen oder Einschränkungen nutzbar zu machen.
...
- [Englisch (English)](glossary.en.md)
- [Arabisch (العربية)](glossary.ar.md)
