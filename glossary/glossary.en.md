...
### Senior User
An older adult typically aged 65+, though the framework principles benefit users of all ages. The term emphasizes respect and dignity rather than limitations.

### Age-Inclusive Design
Design that considers the needs of users across all age ranges, with particular attention to the needs of senior users.
...
### Reversible Actions
Operations that can be undone, allowing users to explore without fear of permanent mistakes.

### Familiar Patterns
Interface elements and behaviors that match users' existing mental models and past experiences.
...
### Test Procedure
A defined method for verifying that a requirement has been properly implemented.
...
### Auditable
A requirement or specification that can be objectively verified through defined testing procedures.
...
### Feedback
System response that informs users about the result of their actions.
...
### Digital Inclusion
The goal of ensuring all people have access to and can benefit from digital technologies.

### Universal Design
Design approach that aims to make products usable by all people to the greatest extent possible.

### Assistive Technology
Hardware or software that helps people with disabilities or age-related limitations use digital products. Examples: screen readers, magnifiers, voice control.

### Mental Model
A user's internal understanding of how something works, based on their experiences and expectations.

### Accessibility
The practice of making digital products usable by people with disabilities or limitations.
...
- [German (Deutsch)](glossary.de.md)
- [Arabic (العربية)](glossary.ar.md)
