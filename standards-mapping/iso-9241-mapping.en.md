...
ISO 9241-210 defines six key principles of human-centered design:
...
## Principle 1: Explicit Understanding of Users
...
- **S4**: Acknowledges reduced fine motor control with larger touch targets
- **A10**: Understands need for respectful, non-patronizing communication
- **E4**: Addresses heightened security concerns with trust indicators
- **E7**: Recognizes value of human support for building confidence
...
- **A2**: "Test with users of varying skill levels"
- **G1**: "Users accurately state current position 95%+ of time"
- **E9**: "Test celebration appropriateness with senior users"
...
| **Development** | Prototype testing, usability studies | A1-A10, G1-G10 validation |
| **Testing** | Acceptance testing, accessibility audit | E1-E10 perception testing |
| **Post-Launch** | Feedback collection, analytics review | Continuous refinement |
...
## Principle 3: User-Centered Evaluation
...
| **A3** | Behavioral | Undo success rate (95%+) |
...
- **A8: Safe Exploration**: Users can try without commitment
- **G8: Forgiving Navigation**: Easy to go back and revise
- **E8: Graceful Performance**: Monitoring enables continuous improvement
...
**How to Apply**:
1. Start with Minimum compliance level
...
## Principle 5: Whole User Experience
...
| **Cognition** | S1, S9, A2, A9, G4 |
| **Decision Making** | A1, A4, A5, G2 |
| **Learning** | A2, A6, A8, G5 |
| **Error Handling** | S7, S8, G10 |
| **Navigation** | S6, G1, G3, G6, G8 |
| **Emotion & Trust** | E3, E4, E6, E7, E9 |
| **Autonomy** | A1, A3, A8, A10 |
| **Performance** | E2, E8 |

**Beyond the Interface**:
- **E7**: Human support availability
- **E6**: Privacy and data transparency
- **E4**: Security and trust building
- **E9**: Recognition of accomplishments

**User Journey Coverage**:
- **Onboarding**: A6, G5, E3
- **Learning**: A2, A6, A8
- **Regular Use**: S6, G3, E1
- **Problem Resolution**: S8, G10, E7
- **Advanced Features**: A9, G7
...
## Principle 6: Multidisciplinary Team
...
| **Content Writers** | E3, A10 tone and language |
| **Accessibility Specialists** | S3, S4, mapping to WCAG |
| **Researchers** | User testing, validation of all requirements |
| **Product Managers** | A5, G4 user needs and business goals |
| **QA Engineers** | Testing procedures, compliance validation |
| **Security/Privacy** | E4, E6 trust and data handling |
...
- ✅ Compliance levels enabling iteration (Principle 4)
- ✅ Holistic four-pillar coverage (Principle 5)
- ✅ Cross-disciplinary requirements (Principle 6)
...
- [German (Deutsch)](iso-9241-mapping.de.md)
- [Arabic (العربية)](iso-9241-mapping.ar.md)
